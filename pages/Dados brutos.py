...
with st.sidebar.expander('Data da compra'):
    data_compra = st.date_input('Selecione a data', (dados['Data da Compra'].min(), dados['Data da Compra'].max())) #Selecionar o range min e max
...
#o @ é pra identificar a variável
query = '''
